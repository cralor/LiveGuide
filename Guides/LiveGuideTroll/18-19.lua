    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { class = "H", action = 40, questName = "Guns", x = 0.409, y = 0.627, mapId = 1456, npcName = "Ansekhwa", },
                { class = "W", action = 40, questName = "Two-Handed Maces", x = 0.409, y = 0.627, mapId = 1456, npcName = "Ansekhwa", },
