    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { class = "Pr", action = 26, questName = "Shadowguard", x = 0.375, y = 0.869, mapId = 1454, npcName = "Zayus", questId = 5680, },
                { class = "Pr", action = 20, questName = "Shadowguard", x = 0.356, y = 0.878, mapId = 1454, npcName = "Ur'kyo", questId = 5680, },
