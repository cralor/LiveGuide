    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { action = 26, questName = "A Swift Message", x = 0.570, y = 0.472, mapId = 1436, npcName = "Quartermaster Lewis", questId = 6181, },
                ...
                { action = 20, questName = "A Swift Message", x = 0.566, y = 0.526, mapId = 1436, npcName = "Thor", questId = 6181, },
                { action = 26, questName = "Continue to Stormwind", x = 0.566, y = 0.526, mapId = 1436, npcName = "Thor", questId = 6281, },
