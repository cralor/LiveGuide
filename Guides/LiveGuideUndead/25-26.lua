    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { class = "Pr", action = 26, questName = "Devouring Plague", x = 0.491, y = 0.146, mapId = 1458, npcName = "Father Lankester", questId = 5646, },
                { class = "Pr", action = 20, questName = "Devouring Plague", x = 0.493, y = 0.171, mapId = 1458, npcName = "Aelthalyste", questId = 5646, },
                { action = 16, questName = "to The Sepulcher", x = 0.633, y = 0.486, mapId = 1458, npcName = "Michael Garrett", },
