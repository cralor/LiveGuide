...
if raceEn:gsub("%s+", ""):lower() == "orc" then
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                { class = "H", action = 26, questName = "Etched Parchment", x = 0.421, y = 0.683, mapId = 1411, npcName = "Gornek", questId = 3087, },
                { class = "Pr", action = 40, questName = "", x = 0.424, y = 0.688, mapId = 1411, npcName = "Ken'jai", },
                { class = "R", action = 26, questName = "Encrypted Parchment", x = 0.421, y = 0.683, mapId = 1411, npcName = "Gornek", questId = 3088, },
                { class = "S", action = 26, questName = "Rune-Inscribed Parchment", x = 0.421, y = 0.683, mapId = 1411, npcName = "Gornek", questId = 3089, },
                { class = "S", action = 20, questName = "Rune-Inscribed Parchment", x = 0.424, y = 0.690, mapId = 1411, npcName = "Shikrik", questId = 3089, },
                { class = "S", action = 40, questName = "", x = 0.424, y = 0.690, mapId = 1411, npcName = "Shikrik", },
                { class = "L", action = 26, questName = "Tainted Parchment", x = 0.421, y = 0.683, mapId = 1411, npcName = "Gornek", questId = 3090, },
                { class = "L", action = 26, questName = "Vile Familiars (L)", x = 0.426, y = 0.690, mapId = 1411, npcName = "Ruzan", questId = 1485, },
                { class = "W", action = 26, questName = "Simple Parchment", x = 0.421, y = 0.683, mapId = 1411, npcName = "Gornek", questId = 2383, },
                { action = 26, questName = "Vile Familiars", x = 0.428, y = 0.692, mapId = 1411, npcName = "Zureetha Fargaze", questId = 792, },
                { class = "H", action = 20, questName = "Etched Parchment", x = 0.428, y = 0.693, mapId = 1411, npcName = "Jen'shan", questId = 3087, },
                { class = "H", action = 40, questName = "", x = 0.428, y = 0.693, mapId = 1411, npcName = "Jen'shan", },
                { class = "W", action = 20, questName = "Simple Parchment", x = 0.429, y = 0.694, mapId = 1411, npcName = "Frang", questId = 2383, },
