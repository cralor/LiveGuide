    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { action = 8, questName = "Hidden Enemies (3)", npcName = "", questId = 5728, },
                { action = 20, questName = "Slaying the Beast", x = 0.495, y = 0.506, mapId = 1454, npcName = "Neeru Fireblade", questId = 5761, },
                { action = 20, questName = "Hidden Enemies (3)", x = 0.316, y = 0.378, mapId = 1454, npcName = "Thrall", questId = 5728, },
                { action = 26, questName = "Hidden Enemies (4)", x = 0.316, y = 0.378, mapId = 1454, npcName = "Thrall", questId = 5729, },
                { action = 20, questName = "Hidden Enemies (4)", x = 0.495, y = 0.506, mapId = 1454, npcName = "Neeru Fireblade", questId = 5729, },
                { action = 26, questName = "Hidden Enemies (5)", x = 0.495, y = 0.506, mapId = 1454, npcName = "Neeru Fireblade", questId = 5730, },
                { action = 20, questName = "Hidden Enemies (5)", x = 0.316, y = 0.378, mapId = 1454, npcName = "Thrall", questId = 5730, },
