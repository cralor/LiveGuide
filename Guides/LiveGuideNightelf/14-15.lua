    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { action = 21, questName = "Grove of the Ancients", x = 0.436, y = 0.763, mapId = 1439, npcName = "Onu", questId = 952, },
                ...
                { action = 35, questName = "The Absent Minded Prospector", x = 0.374, y = 0.418, mapId = 1439, npcName = "Archaeologist Hollee", questId = 729, },
                ...
                { action = 21, questName = "Return to Nessa", x = 0.563, y = 0.924, mapId = 1438, npcName = "Nessa Shadowsong", questId = 6343, },
                { action = 26, questName = "Trouble In Darkshore?", x = 0.312, y = 0.632, mapId = 1457, npcName = "Chief Archaeologist Greywhisker", questId = 730, },
                { class = "D", action = 40, questName = "", x = 0.354, y = 0.084, mapId = 1457, npcName = "Mathrengyl Bearwalker", },
                { class = "D", action = 26, questName = "Lessons Anew", x = 0.354, y = 0.084, mapId = 1457, npcName = "Mathrengyl Bearwalker", questId = 6121, },
                ...
                { class = "W", action = 20, questName = "The Shade of Elura", x = 0.573, y = 0.346, mapId = 1457, npcName = "Elanaria", questId = 1686, },
                { class = "W", action = 26, questName = "Smith Mathiel", x = 0.573, y = 0.346, mapId = 1457, npcName = "Elanaria", questId = 1692, },
                { class = "W", action = 20, questName = "Smith Mathiel", x = 0.595, y = 0.454, mapId = 1457, npcName = "Mathiel", questId = 1692, },
                { class = "W", action = 30, questName = "Weapons of Elunite", x = 0.595, y = 0.454, mapId = 1457, npcName = "Mathiel", questId = 1693, },
                { class = "HMPaPrRLW", action = 18, questName = "to Rut'theran Village", x = 0.300, y = 0.413, mapId = 1457, npcName = "", },
