    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { action = 20, questName = "Trouble In Darkshore?", x = 0.374, y = 0.418, mapId = 1439, npcName = "Archaeologist Hollee", questId = 730, },
                { action = 27, questName = "The Absent Minded Prospector", x = 0.374, y = 0.418, mapId = 1439, npcName = "Archaeologist Hollee", questId = 729, },
