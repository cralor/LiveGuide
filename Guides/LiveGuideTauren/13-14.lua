...
if raceEn:gsub("%s+", ""):lower() == "tauren" then
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                { class = "W", action = 18, questName = "up Thorn Hill", x = 0.595, y = 0.281, mapId = 1413, npcName = "", },
                ...
                { class = "W", action = 7, questName = "Forged Steel", x = 0.550, y = 0.267, mapId = 1413, npcName = "<Stolen Iron Chest>", questId = 1503, },
