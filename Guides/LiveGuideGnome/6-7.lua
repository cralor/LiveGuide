    ...
    LiveGuide.registerLevel({
        ...
        steps = function()
            return {
                ...
                { class = "W", action = 6, questName = "[Gladius]", x = 0.453, y = 0.522, mapId = 1426, npcName = "Grawn Thromwyn", notes = "Sell your old weapons if you just barely don't have enough money.", },
